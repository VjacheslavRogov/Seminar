...
def sum_points(num):
    result = sum([k for i in word for k, v in num.items() if i in v])
    return result
...
if N == 1:
    print('За это слово вы получаете', sum_points(eng), 'очков')
elif N == 0:
    print('За это слово вы получаете', sum_points(rus), 'очков')
else:
